namespace GeneralStoreAPI.Migrations
{
    ...
    public partial class Another : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        NumberInventory = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.SKU);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Transactions", "CustometId", "dbo.Customers");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropIndex("dbo.AspNetUserLogins", new[] { "UserId" });
            DropIndex("dbo.AspNetUserClaims", new[] { "UserId" });
            DropIndex("dbo.AspNetUsers", "UserNameIndex");
            DropIndex("dbo.Transactions", new[] { "ProductSKU" });
            DropIndex("dbo.Transactions", new[] { "CustometId" });
